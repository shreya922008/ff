...
function setup() {
  ...
  ground1 = new Ground(170, 200, 320, 20);
   ...
   BlockPink1 = new BoxPink(201, 182, 20, 20);
   BlockPink2 = new BoxPink(220, 182, 20, 20);
   BlockPink3 = new BoxPink(240, 182, 20, 20);
   BlockPink4 = new BoxPink(260, 182, 20, 20);
   BlockPink5 = new BoxPink(280, 182, 20, 20);
   BlockPink6 = new BoxPink(300, 182, 20, 20);
   BlockPink7 = new BoxPink(320, 182, 20, 20);
